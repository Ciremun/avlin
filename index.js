...
var ASM_CONSTS = {
 ...
 115941: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } return 0; },  
 116034: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 116103: () => { return window.innerWidth; },  
 116133: () => { return window.innerHeight; }
};
